...
[Authorize]
[DefaultClassOptions]
public partial class TelegramUniqueGiftSymbol : BaseObject, INotifyPropertyChanging, INotifyPropertyChanged
{
    ...
    [JsonIgnore(Condition = JsonIgnoreCondition.Never)]
    [InverseProperty(nameof(Sticker.UniqueGiftSymbolThisStickerBelongsTo))]
    ...
    [InverseProperty(nameof(TelegramUniqueGift.Symbol))]
    public virtual IList<TelegramUniqueGift>? UniqueGiftThisUniqueGiftSymbolBelongsTo { get; set; } = new ObservableCollection<TelegramUniqueGift>();
}